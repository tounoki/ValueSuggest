...
class DenoSuggest implements SuggesterInterface
{
    /**
     * @var Client
     */
    ...
    public function getSuggestions($query)
    {
        ...
        $response = $this->client
        ->setUri('http://museo.tounoki.org/thesaurus/denomination/services.php')
        ...
        foreach ($results['result'] as $result) {
            ...
            $suggestions[] = [
                'value' => $result['string'] ,
                'data' => [
                    'uri' => sprintf('http://museo.tounoki.org/thesaurus/denomination/index.php?tema=%s', $result['term_id']),
                    'info' => $info,
                ],
            ];
        }
